...
namespace fun 
{
  ...
  struct matrix3
  {
    ...
    constexpr matrix3(const _Tp& a, const _Tp& b, const _Tp& c,
		      const _Tp& d, const _Tp& e, const _Tp& f,
		      const _Tp& g, const _Tp& h, const _Tp& i
		      ) 
      : _a(a), _b(b), _c(c), 
	_d(d), _e(e), _f(f),
        _g(g), _h(h), _i(i) { }
    ...
    matrix3(const matrix3<_Up>& B) 
      : _a(B.a()), _b(B.b()), _c(B.c()), 
	_d(B.d()), _e(B.e()), _f(B.f()),
	_g(B.g()), _h(B.h()), _i(B.i()) { }

    /// Construct from vectors
    template<typename _Up>
    matrix3(const vector3<_Up>& v1, 
	    const vector3<_Up>& v2, 
	    const vector3<_Up>& v3) 
      : _a(v1.e1()), _b(v2.e1()), _c(v3.e1()), 
	_d(v1.e2()), _e(v2.e2()), _f(v3.e2()),
	_g(v1.e3()), _h(v2.e3()), _i(v3.e3()) { }
    ...
    constexpr _Tp e() { return _e; }

    /// Return sixth element of matrix.
    constexpr _Tp f() { return _f; }

    /// Return seventh element of matrix.
    constexpr _Tp g() { return _g; }

    /// Return eighth element of matrix.
    constexpr _Tp h() { return _h; }

    /// Return ninth element of matrix.
    constexpr _Tp i() { return _i; }
    ...
    template<typename _Up>
    matrix3<_Tp>& operator=(const matrix3<_Up>& B)
    { 
      _a = B.a(); _b = B.b(); _c = B.c(); 
      _d = B.d(); _e = B.e(); _f = B.f();
      _g = B.g(); _h = B.h(); _i = B.i(); 
  ...
  private:
    _Tp _a; _Tp _b; _Tp _c;
    _Tp _d; _Tp _e; _Tp _f;
    _Tp _g; _Tp _h; _Tp _i;
  };
  ...
  template<typename _Tp>
  inline matrix3<_Tp>
  operator+(const matrix3<_Tp>& A, const matrix3<_Tp>& B)
  {
    matrix3<_Tp> r = A;
    r += B;
    return r;
  ...
  template<typename _Tp>
  inline matrix3<_Tp>
  operator*(const matrix3<_Tp>& A, const _Tp& a)
  {
    matrix3<_Tp> r = A;
    r *= a;
    return r;
  ...
  template<typename _Tp>
  inline matrix3<_Tp>
  operator*(const _Tp& a, const matrix3<_Tp>& A)
  {
    matrix3<_Tp> r = A;
    r *= a;
    return r;
  ...
  operator-(const matrix3<_Tp>& A)
  { 
    return matrix3<_Tp>(-A.a(), -A.b(), -A.c(),
			-A.d(), -A.e(), -A.f(),
			-A.g(), -A.h(), -A.i()); 
  }
  ...
  template<typename _Tp>
  inline vector3<_Tp>
  operator*(const matrix3<_Tp>& A, const vector3<_Tp>& v)
  { 
    return 
      vector3<_Tp>
      ( A.a()*v.e1() + A.b()*v.e2() + A.c()*v.e3(), 
  ...
  /// Return transpose of this matrix (WildLinAlg8)
  matrix3<_Tp> transpose(const matrix3<_Tp>& A)
  { 
    return matrix3<_Tp>
	(  A.a(), A.d(), A.g(),
	   A.b(), A.e(), A.h(),
  ...
  operator<<(std::basic_ostream<_CharT, _Traits>& os, const matrix3<_Tp>& A)
  {
